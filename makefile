...
main:  mapa.o comida.o juego.o 
	$(CC) $(CFLAGS) $(DEBUG) $(SRC_DIR)main.cpp -o serpiente $(OBJ_DIR)juego.o $(OBJ_DIR)comida.o $(OBJ_DIR)serpiente.o $(OBJ_DIR)mapa.o $(OBJ_DIR)global.o -lncurses $(INCLUDESG)

juego.o: object mapa.o comida.o global.o serpiente.o
